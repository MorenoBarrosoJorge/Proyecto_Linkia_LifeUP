...
@Composable
fun SignupScreen(auth: FirebaseAuth, navigateToMenu: () -> Unit, navigateBack: () -> Unit, viewModel: SignupViewModel = viewModel()) {
    ...
    Column(
        ...
        Box(
            ...
            Button(
                ...
                enabled = viewModel.contrasenaValida(password, confirmarPassword),
